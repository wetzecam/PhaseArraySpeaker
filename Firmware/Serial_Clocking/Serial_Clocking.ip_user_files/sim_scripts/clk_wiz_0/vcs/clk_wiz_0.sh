...
#
# Generated by Vivado on Fri Oct 15 17:17:02 CDT 2021
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Serial_Clocking.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Serial_Clocking.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/cameron/PhaseArraySpeaker/Firmware/Serial_Clocking/Serial_Clocking.cache/compile_simlib/vcs"
  fi
