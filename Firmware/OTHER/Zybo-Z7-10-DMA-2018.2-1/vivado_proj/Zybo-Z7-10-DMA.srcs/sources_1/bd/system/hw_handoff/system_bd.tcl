...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BCK_int [ create_bd_port -dir O BCK_int ]
  set LRCK_int [ create_bd_port -dir O LRCK_int ]
  set MCK_int [ create_bd_port -dir O MCK_int ]
  ...
  connect_bd_net -net d_axi_i2s_audio_0_BCK_int [get_bd_ports BCK_int] [get_bd_pins d_axi_i2s_audio_0/BCK_int]
  connect_bd_net -net d_axi_i2s_audio_0_BCLK_O [get_bd_ports ac_bclk] [get_bd_pins d_axi_i2s_audio_0/BCLK_O]
  connect_bd_net -net d_axi_i2s_audio_0_LRCK_int [get_bd_ports LRCK_int] [get_bd_pins d_axi_i2s_audio_0/LRCK_int]
  connect_bd_net -net d_axi_i2s_audio_0_MCK_int [get_bd_ports MCK_int] [get_bd_pins d_axi_i2s_audio_0/MCK_int]
  connect_bd_net -net d_axi_i2s_audio_0_MCLK_O [get_bd_ports ac_mclk] [get_bd_pins d_axi_i2s_audio_0/MCLK_O]
  connect_bd_net -net d_axi_i2s_audio_0_PLL_Locked [get_bd_ports PLL_Locked] [get_bd_pins d_axi_i2s_audio_0/PLL_Locked]
