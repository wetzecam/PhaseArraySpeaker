...
HD_PWD='/home/cameron/PhaseArraySpeaker/Firmware/2018.2/Zynq_Base_Phased_Array/Zynq_Base_Phased_Array.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Base_Phased_Array_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq_Base_Phased_Array_wrapper.tcl -notrace
