...
HD_PWD='/home/cameron/PhaseArraySpeaker/Firmware/2018.2/Zynq_Base_Phased_Array/Zynq_Base_Phased_Array.runs/Saw_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Saw_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Saw_ROM.tcl
