...
HD_PWD='/home/cameron/PhaseArraySpeaker/Firmware/2018.2/Zynq_Base_Phased_Array/Zynq_Base_Phased_Array.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Base_Phased_Array_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_Base_Phased_Array_wrapper.tcl
