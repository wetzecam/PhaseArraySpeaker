...
HD_PWD='/home/cameron/PhaseArraySpeaker/Firmware/2017.2/Phase_Array_DSP_AUX/Phase_Array_DSP_AUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_I2C_CODEC_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_I2C_CODEC_wrapper.tcl
